...
class CST_PT_ShaderController_pnl(bpy.types.Panel):
    ...
    bpy.types.Scene.controller_empty = PointerProperty(name="Shader Controller", type=bpy.types.Object)
    bpy.types.Scene.character_collection = PointerProperty(name= "Character Collection", type= bpy.types.Collection)
    ...
    def draw(self, context):
        ...
        layout.prop_search(scene, "controller_empty", context.scene, "objects", text="Shader Controller")
        layout.prop_search(scene, "character_collection", bpy.data, "collections", text="Character Collection")
