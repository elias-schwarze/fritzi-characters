...
class fritziGPSettings(PropertyGroup):
    ...
    extraexcluded_collection : PointerProperty(name="Objects Excluded Other", type=bpy.types.Collection)
...
class FDG_PT_DriverGenOutlinesDebug_pnl(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop_search(settings, "extraexcluded_collection", bpy.data, "collections")
