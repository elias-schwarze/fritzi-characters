...
from .driver_gen_outlines import fdg_driver_gen_preview_outlines_ops
...
def register():
    ...
    fdg_driver_gen_preview_outlines_ops.register()
...
def unregister():
    ...
    fdg_driver_gen_preview_outlines_ops.unregister()
